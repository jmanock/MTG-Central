...
Error: File to import not found or unreadable: vars.
       Load path: /Users/asoper/MTG-Central
        on line 1 of ./node_modules/gulp-sass/node_modules/node-sass/test/include_path.scss

1: @import "vars";
2: @import "colorBlue";
3: 
4: body { background: $color; color: colorBlue(); }

Backtrace:
./node_modules/gulp-sass/node_modules/node-sass/test/include_path.scss:1
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.9/lib/sass/tree/import_node.rb:66:in `rescue in import'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.9/lib/sass/tree/import_node.rb:45:in `import'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.9/lib/sass/tree/import_node.rb:28:in `imported_file'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.9/lib/sass/tree/import_node.rb:37:in `css_import?'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.9/lib/sass/tree/visitors/perform.rb:301:in `visit_import'
...
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.9/lib/sass/plugin/compiler.rb:293:in `watch'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.9/lib/sass/plugin.rb:108:in `method_missing'
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.9/lib/sass/exec/sass_scss.rb:370:in `watch_or_update'
...
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.9/bin/sass:13:in `<top (required)>'
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: vars.\A        Load path: /Users/asoper/MTG-Central\A         on line 1 of ./node_modules/gulp-sass/node_modules/node-sass/test/include_path.scss\A \A 1: @import \"vars\";\A 2: @import \"colorBlue\";\A 3: \A 4: body { background: $color; color: colorBlue(); }"; }
